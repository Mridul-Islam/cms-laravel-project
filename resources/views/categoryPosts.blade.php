                ...
                @foreach($posts as $post)
                    <div class="card" style="margin-bottom: 50px">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center">{{ Str::limit($post->body, 300) }}</p>
                            <p class="card-text text-center"><small class="text-muted">Last updated {{$post->updated_at->diffForHumans()}}</small></p>
                        </div>
                        <img height="300px" class="card-img-bottom" src="{{$post->photo_id ? "../images/" . $post->photo->image : "../images/post.jpg"}}" alt="Card image cap">
                        <hr/>
